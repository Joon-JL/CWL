#!/usr/bin/env python3
# $Id: hmmer3_hmmscan3.py 2106 2017-06-01 17:00:40Z afoix $
# ======================================================================
# HMMER3 hmmscan (REST) Python 3 client using urllib3 and
...
#baseUrl = 'http://www.ebi.ac.uk/Tools/services/rest/hmmer3_hmmscan'
baseUrl = 'http://ashdev-2.ebi.ac.uk:9889/Tools/services/rest/hmmer3_hmmscan'
...
version = "$Id: hmmer3_hmmscan3.py 2809 2017-06-01 11:52:25Z afoix $"
# Process command-line options
parser = OptionParser(usage=usage, description=description, epilog=epilog, version=version)
# Tool specific options
parser.add_option('--email', help='e-mail address')
parser.add_option('--database', '--hmmDatabase', help='database to search, Pfam Tigrfam gene3d pirsf superfamily are available')
...
# Submit job
    ...
    if options.database:
        params['hmmDatabase'] = options.database
